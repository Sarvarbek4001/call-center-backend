...
module.exports = {
  ...
  POST: async (req, res) => {
    try {
      const { title, content, b_row_reverse, section_id } = req.body;
      console.log(title, content, b_row_reverse, section_id);
  ...
  PUT: async (req, res) => {
    try {
      const { title, content, b_row_reverse, blockId } = req.body;
      console.log(title, content, b_row_reverse, blockId);
